...
function linkAction() {
   ...
   //When we click on each nav link, we remove the show remove class
...
function scrollTop() {
   ...
   //when the scroll is higher than 500 viewport hieght, add the show-scroll class to the a tag with the scroll
   if (this.scrollY >= 200)
